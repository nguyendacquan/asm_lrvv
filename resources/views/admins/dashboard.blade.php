                    ...
                    <div class="row g-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-baseline mb-2">
                                        <div class="fs-15 mb-0 me-2 fw-semibold text-black">{{ $tongDonHangs }} đơn hàng
                                        </div>
                                        <div class="me-auto">
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="fs-14 mb-1">Tổng tiền</div>
                                    </div>

                                    <div class="d-flex align-items-baseline mb-2">
                                        <div class="fs-15 mb-0 me-2 fw-semibold text-black">{{ number_format($tongTien) }} đ
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="fs-14 mb-1">Trạng thái đơn hàng</div>
                                    </div>

                                    <div class="d-flex align-items-baseline">
                                        <div class="fs-15 me-2 fw-semibold text-black">
                                            <p>hoàn thành: {{ $donHangDaGiao }} <br>
                                                đang xác nhận: {{ $donHangDangXuLy }} <br>
                                                đã hủy: {{ $donHangHuy }}</p>
                                        </div>
                                    </div>
