            ...
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link"
                            href="{{ route('clients.index') }}"><img class="main__logo--img"
                                src="{{ asset('assets/clients/img/logo/nav-log2.png') }}" alt="logo-img"></a>
                    </h1>
                </div>
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="index.html">
                    <img src="{{ asset('assets/clients/img/logo/nav-log2.png') }}" alt="Grocee Logo"
                        width="158" height="36">
                </a>
            ...
            <nav class="offcanvas__menu">
                <ul class="offcanvas__menu_ul">
                    <li class="offcanvas__menu_li">
                        <a class="offcanvas__menu_item" href="{{ route('clients.index') }}">Home</a>
                        ...
                        <li class="language__currency--list">
                            <a class="offcanvas__language--switcher" href="#">
                                <img class="language__switcher--icon__img"
                                    src="{{ asset('assets/clients/img/icon/language-icon.png') }}"
                                    alt="currency">
                                <span>English</span>
    ...
    <div class="offCanvas__minicart color-scheme-2">
        ...
        <div class="minicart__product">
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img
                            src="{{ asset('assets/clients/img/product/product1.png') }}" alt="prduct-img"></a>
                </div>
            ...
            <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img
                            src="{{ asset('assets/clients/img/product/product2.png') }}" alt="prduct-img"></a>
                </div>
                <div class="minicart__text">
