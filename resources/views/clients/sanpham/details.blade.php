            ...
            <div class="col-lg-12 order-1 order-lg-2">
                ...
                <div class="product-details-inner">
                        ...
                        <div class="col-lg-5">
                            <div class="product-large-slider">
                                <div class="pro-large-img img-zoom">
                                    <img style="border-radius:4px" src="{{url('storage/',$SanPham->hinh_anh)}}" alt="product-details" />
                                </div>
                               @foreach ($SanPham->hinhAnhSanPham as $item)
                               <div class="pro-large-img img-zoom">
                                <img style="border-radius:4px" src="{{url('storage/',$item->hinh_anh)}}" alt="product-details" />
                            </div>
                               @endforeach
                    ...
                    <div class="product-countdown" data-countdown="2022/12/20"></div>
                                ...
                                <p class="pro-desc">{!!$SanPham->noi_dung!!}</p>
                                        ...
                                        <form action="#" class="review-form">
                                            ...
                                            <div class="total-reviews">
                                                <div class="rev-avatar">
                                                    <img src="{{asset('assets/clients/img/about/avatar.jpg')}}" alt="">
                                                </div>
