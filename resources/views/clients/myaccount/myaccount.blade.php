                                ...
                                <div class="account-details-form">
                                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="single-input-item">
                                            ...
                                            <input type="text" id="address" name="dia_chi" placeholder="Address" value="{{ $user->dia_chi }}"  />
                                        </div>
                                    
                                        <div class="single-input-item">
                                            <label for="phone">Phone Number</label>
                                            <input type="text" id="phone" name="so_dien_thoai" placeholder="Phone Number" value="{{ $user->so_dien_thoai }}"  />
                                        </div>
