                                    ...
                                    <div class="row row-cols-1">
                                        <div class="col">
                                            <div class="slider__content">
                                                <p class="slider__content--desc desc1 text__secondary2 mb-15"> Big
                                                    Offer 50% off</p>
                                                <h2 class="slider__content--maintitle h1">New Collection <br>
                                                    Summer Sale</h2>
                                                <p class="slider__content--desc desc2 d-sm-2-none mb-40">Lorem ipsum
                                                    dolor sit amet, consectetur adipisicing elit, sed do <br> eiusmod
                    ...
                    <div class="swiper-slide ">
                        <div class="hero__slider--items home2__slider--bg two">
                            <div class="container-fluid">
                                <div class="hero__slider--items__inner hero__slider--bg2__inner">
                                    <div class="slider__content">
                                        <p class="slider__content--desc desc1 text__secondary2 mb-15"> Big Offer 50%
                                            off</p>
                                        <h2 class="slider__content--maintitle h1">New Collection <br>
                                            Summer Sale</h2>
            ...
            <div class="container-fluid">
                ...
                <div class="product__section--inner">
                    <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                        ...
                        @yield('sanpham')
                        @foreach ($ClientSanPham as $item)
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link"
                                            href="{{ route('details', ['id' => $item->id]) }}">
                                            <img class="product__items--img product__primary--img"
                                                src="{{ url('storage/', $item->hinh_anh) }}" alt="product-img">
                                            {{-- <img class="product__items--img product__secondary--img"
                                        src="{{asset('assets/clients/img/product/product2.png')}}" alt="product-img"> --}}
                                        </a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">Sale</span>
                                        </div>
                                        <a class="product__add-to__cart--btn__style2 "
                                            href="{{ route('cart', ['id' => $item->id]) }}">
                                    ...
                                    <div class="product__items--content text-center">
                                        ...
                                        <h3 class="product__items--content__title h4"><a
                                                href="{{ route('details', ['id' => $item->id]) }}">{{ $item->ten_san_pham }}</a>
                                        </h3>
                                        <div class="product__items--price">
                                            <span class="current__price">${{ $item->gia }}</span>
                        ...
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail width-100 " href="shop.html"><img
                                ...
                                <div class="banner__items--content__style3">
                                    <span class="banner__items--content__style3--subtitle text-white">Wmen's
                                        Collection</span>
                                    <h2 class="banner__items--content__style3--title text-white h3"> Min.40-70% Off
                                    </h2>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="product__grid--wrapper">
                            ...
                            <div class="product__grid--inner">
                                ...
                                <div class="product__items product__items--grid d-flex align-items-center">
                                    ...
                                    <div class="product__items--grid__content">
                                        <h3 class="product__items--content__title h4"><a
                                                href="product-details.html">Gorgeous Granite Clock</a></h3>
                                        <div class="product__items--price">
                                ...
                                <div class="product__items product__items--grid d-flex align-items-center">
                                    ...
                                    <div class="product__items--grid__content">
                                        <h3 class="product__items--content__title h4"><a
                                                href="product-details.html">Durable Steel Knife</a></h3>
                                        <div class="product__items--price">
                        ...
                        <div class="col col-sm-order">
                            <div class="shop__card--content">
                                ...
                                <h2 class="shop__card--content__maintitle mb-12">Support your <br>
                                    neighborhood</h2>
                                <p class="shop__card--content__desc">We believe that local businesses are an integral
                                    <br> part of a neighborhood's character. Help keep <br> local by buying a gift card!
                                </p>
                            ...
                            <div class="testimonial__items--style2 testimonial__items text-center">
                                ...
                                <div class="testimonial__items--content">
                                    ...
                                    <p class="testimonial__items--desc style2 text-white">Lorem ipsum dolor sit amet,
                                        consectetur adipisicin elit, sed do eiusmod tempor incididunt ut labore et
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="blog__items">
                                ...
                                <div class="blog__content style2">
                                    ...
                                    <h3 class="blog__content--title style2"><a href="blog-details.html">Fashion
                                            Trends In 2021 Styles,
                                            Colors, Accessories</a></h3>
                                    <a class="blog__content--btn style2 primary__btn" href="blog-details.html">Read
                                        more </a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="blog__items">
                                ...
                                <div class="blog__content style2">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title style2"><a href="blog-details.html">Meet the
                                            Woman Behind Cool
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                ...
                                <div class="blog__content style2">
                                    <span class="blog__content--meta">February 03, 2022</span>
                                    <h3 class="blog__content--title style2"><a href="blog-details.html">Lauryn Hill
                                            Could Make Tulle
